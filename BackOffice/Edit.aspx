...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:DropDownList ID="txtProductCategory" runat="server" CssClass="form-control"></asp:DropDownList>
        </div>
   ...
   <div class="col-md-4">
    <label for="lblIDCategory" class="form-label txt-lbladd">Select Categories</label>
    <asp:DropDownList ID="txtIDCategory" runat="server" AutoPostBack="true" CssClass="form-select dp-dw-cat">
