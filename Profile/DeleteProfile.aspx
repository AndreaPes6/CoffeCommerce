            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header" style="background-color: #0C141A;">
                        <h5 class="card-title text-light">Delate Profile</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-flex justify-content-center">
                           <a href="../Profile/MyProfile.aspx" class="btn btn-secondary rounded me-3">Torna alla Home</a>
                           <asp:Button ID="btnDelete" runat="server" Text="Elimina Profilo" OnClick="btnDelete_Click" CssClass="btn btn-danger rounded" />
                        </div>
                    </div>
                </div>
            </div>
